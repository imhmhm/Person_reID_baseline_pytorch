...
which_epochs = opt.which_epochs
name = opt.name
test_dir = opt.test_dir
test_sets = opt.test_sets
...
for test_set in test_sets:
    ...
    for which_epoch in which_epochs:
        ...
        feat_path = os.path.join('./model', name, test_set, 'pytorch_result_{}.mat'.format(which_epoch))
        scipy.io.savemat(feat_path, result)
        if opt.multi:
            result = {'mquery_f': mquery_feature.numpy(), 'mquery_label': mquery_label, 'mquery_cam': mquery_cam}
            multi_path = os.path.join('./model', name, test_set, 'multi_query_{}.mat'.format(which_epoch))
