...
######################################################################
feat_path = os.path.join('./model_gen', opt.name, opt.test_set, 'pytorch_result_{}.mat'.format(opt.which_epoch))
...
multi = opt.multi
if multi:
    multi_path = os.path.join('./model_gen', opt.name, opt.test_set, 'multi_query_{}.mat'.format(opt.which_epoch))
...
csv_path = os.path.join('./model_gen', opt.name, opt.test_set, 'result.csv')
